...
import { Mail, Lock, LogIn, Sparkles, AlertCircle, PlayCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-5 animate-fadeIn">
      ...
      <button
        ...
        className="w-full py-2.5 bg-slate-950 hover:bg-slate-800 border border-slate-800 hover:border-slate-700 text-white font-bold text-xs rounded-xl transition-all flex items-center justify-center gap-2.5 active:scale-95"
      >
      ...
      {/* Demo Mode Button (if Supabase not configured in .env) */}
      {!isConfigured && (
